...
!function(window) {
    ...
    ActionSheet.prototype.open = function() {
        ...
        $mask.on('http://www.17sucai.com/preview/1268063/2018-08-16/page/js/click.ydui.actionsheet.mask', function() {
            _this.close();
        });
    ...
    ActionSheet.prototype.close = function() {
        ...
        $mask.off('http://www.17sucai.com/preview/1268063/2018-08-16/page/js/click.ydui.actionsheet.mask').remove();
