...
!function(window) {
    ...
    Tab.prototype.bindEvent = function() {
        ...
        _this.$nav.each(function(e) {
            $(this).on('http://www.17sucai.com/preview/1268063/2018-10-15/order/js/click.ydui.tab', function() {
                _this.open(e);
            });
        });
    }
    ...
    Tab.prototype.open = function(index) {
        ...
        _this.active(_this.$panel.eq(index), _this.$panel, function() {
            $curNav.trigger({
                type: 'http://www.17sucai.com/preview/1268063/2018-10-15/order/js/opened.ydui.tab',
                index: index
            });
    ...
    function Plugin(option) {
        ...
        return this.each(function() {
            var target = this
              , $this = $(target)
              , tab = $this.data('http://www.17sucai.com/preview/1268063/2018-10-15/order/js/ydui.tab');

            if (!tab) {
                $this.data('http://www.17sucai.com/preview/1268063/2018-10-15/order/js/ydui.tab', (tab = new Tab(target,option)));
            }
    ...
    $(window).on('http://www.17sucai.com/preview/1268063/2018-10-15/order/js/load.ydui.tab', function() {
